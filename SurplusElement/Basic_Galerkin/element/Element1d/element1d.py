import numpy as np
from SurplusElement.Basic_Galerkin.element.Element1d.AuxClasses import DirichletBoundaryCondition as DBC
from SurplusElement.Basic_Galerkin.element.Element1d.AuxClasses import ApproximationSpaceParameter as ASP
from enum import Enum
from SurplusElement.Basic_Galerkin.element.Element1d.ElementTypes.PolyAffineElement import PolyAffineElement as PolyAffine
from SurplusElement.Basic_Galerkin.element.Element1d.ElementTypes.PeriodicCardinalElement import PeriodicCardinalElement as PeriodicCardinal
from SurplusElement.Basic_Galerkin.element.Element1d.ElementTypes.RationalInfHalfSpaceElement import RationalInfHalfSpaceElement as RationalInfHalfSpace
from SurplusElement.Basic_Galerkin.element.Element1d.ElementTypes.ExponentialInfHalfSpaceElement import ExponentialInfHalfSpaceElement as ExponentialInfHalfSpace
from SurplusElement.Basic_Galerkin.element.Element1d.ElementTypes.ShiftedLaguerreFunctionElement import ShiftedLaguerreFunctionElement as ShiftedLaguerreFunction
from SurplusElement.Basic_Galerkin.element.Element1d.ElementTypes.LogarithmicInfHalfSpaceElement import LogarithmicInfHalfSpaceElement as LogarithmicInfHalsSpace
from SurplusElement.Basic_Galerkin.element.Element1d.ElementTypes.ShiftedHermiteFunctionElement import ShiftedHermiteFunctionElement as SchiftedHermiteFunction
