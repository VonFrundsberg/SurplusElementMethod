...
def firstOrderODE_Zero_Dirichlet(nodesAmount: int, func, funcDerivative, func2Derivative):
    ...
    derivative2_ApproxSolution = sp_lin.solve(FD2_Matrix, derivativeValues  * h)
    derivative4_ApproxSolution = sp_lin.solve(FD4_Matrix, derivativeValues  * h)
    derivative8_ApproxSolution = sp_lin.solve(FD8_Matrix, derivativeValues * h)
    derivative16_ApproxSolution = sp_lin.solve(FD16_Matrix,derivativeValues * h)
